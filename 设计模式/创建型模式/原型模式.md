...
![image-20210816223417497](./原型模式.assets/image-20210816223417497-16291258763211.png)
...
![image-20210816223605601](./原型模式.assets/image-20210816223605601.png)
...
public:
    ...
    prototype(prototype other) : _name(other._name) {}
...
public:
    ConcretePrototype1(string type) : _type(type) {}

    ConcretePrototype1(ConcretePrototype1 *other) : prototype(other), _type(other->_type) {}
...
public:
    ConcretePrototype2(string time) : _time(time) {}

    ConcretePrototype2(ConcretePrototype2 *other) : prototype(other), _type(other->_time) {}
...
class PrototypeFactory {
 ...
 public:
  PrototypeFactory() {
    prototypes_[Type::PROTOTYPE_1] = new ConcretePrototype1("PROTOTYPE_1 ");
    prototypes_[Type::PROTOTYPE_2] = new ConcretePrototype2("PROTOTYPE_2 ");
  }
